...
function removeBook(
  ...
  setFilteredBooks: React.Dispatch<React.SetStateAction<typeof books>>
): void {
  const bookTitle = (e.currentTarget.nextSibling as HTMLElement).title;
      ...
      <dialog className="form-dialog">
        <form onSubmit={handleSubmit}>
          <div className="form-header">
            ...
            <button onClick={handleCloseForm} className="close-form-btn">
              X
            </button>
          </div>
          <hr></hr>
